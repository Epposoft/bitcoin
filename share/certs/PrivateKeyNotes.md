...
unlocked to sign the EPPO-Qt.app bundle.
...
allowing somebody to distribute a EPPO-Qt.app or EPPO-qt-setup.exe with a valid
...
that the EPPO-qt.exe file inside the installer had not been tampered with.

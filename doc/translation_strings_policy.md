...
This document provides guidelines for internationalization of the EPPO Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `EPPO_en.ts` remains unchanged.

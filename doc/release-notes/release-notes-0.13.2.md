EPPO Core version 0.13.2 is now available from:

  <https://EPPO.org/bin/EPPO-core-0.13.2/>
...
- #8908 `4a974b2` Update EPPO-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow EPPO-tx to create v2 transactions (btcdrak)

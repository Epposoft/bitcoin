EPPO-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/EPPO/files/EPPO/EPPO-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the EPPO
...
New/changed settings (command-line or EPPO.conf file)
--------------------------------------------------------

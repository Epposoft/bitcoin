EPPO Core version 0.10.4 is now available from:

  <https://EPPO.org/bin/EPPO-core-0.10.4/>
...
- #6953 `43c2789` Split EPPO-tx into its own package
- #6953 `dfe0d4d` Include EPPO-tx binary on Debian/Ubuntu

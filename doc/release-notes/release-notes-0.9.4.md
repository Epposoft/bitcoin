EPPO Core version 0.9.4 is now available from:

  https://EPPO.org/bin/0.9.4/
...
this update is incompatible with the EPPO system and could lead to consensus
forks.

EPPO Core released binaries from https://EPPO.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~EPPO/+archive/ubuntu/EPPO
- A third-party or self-compiled EPPO Core

upgrade to EPPO Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

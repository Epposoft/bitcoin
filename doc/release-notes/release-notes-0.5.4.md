EPPO version 0.5.4 is now available for download at:
http://sourceforge.net/projects/EPPO/files/EPPO/EPPO-0.5.4/
...
http://gitorious.org/EPPO/EPPOd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix EPPO-Qt notifications under Growl 1.3.
Increase required age of EPPO-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEPPO properly when installing EPPO-Qt over it. (Windows)

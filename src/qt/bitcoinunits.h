...
#ifndef EPPO_QT_EPPOUNITS_H
#define EPPO_QT_EPPOUNITS_H
...
/** EPPO unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EPPOUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EPPOUnits(QObject *parent);

    /** EPPO units.
      @note Source: https://en.EPPO.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        epc,
...
typedef EPPOUnits::Unit EPPOUnit;

#endif // EPPO_QT_EPPOUNITS_H

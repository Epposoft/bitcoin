...
#ifndef EPPO_TEST_SCRIPTNUM10_H
#define EPPO_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from EPPO Core 0.10.0, for cross-comparison.
 */
public:

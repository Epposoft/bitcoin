...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s EPPO-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  EPPO-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded EPPO transaction") + "\n" +
              "  EPPO-tx [options] -create [commands]   " + _("Create hex-encoded EPPO transaction") + "\n" +
              "\n";
...
static void MutateTxAddOutPubKey(CMutableTransaction& tx, const std::string& strInput)
{
    ...
    CEPPOAddress addr(scriptPubKey);
    ...
    if (bScriptHash) {
        ...
        CEPPOAddress redeemScriptAddr(scriptPubKey);
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded EPPO transaction

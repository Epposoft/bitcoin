...
# TestNode: A peer we use to send messages to EPPOd, and store responses.
...
class CompactBlocksTest(EPPOTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes EPPOd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that EPPOd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for EPPOd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # EPPOd will not send blocktxn responses for blocks whose height is
